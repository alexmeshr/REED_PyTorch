...
class CIFAR10(data.Dataset):
    ...
    def __init__(self, root, train=True,
                 ...
                 download=False,
                 noise_type='symmetric', noise_rate=0.2, random_state=0, clear_labels=None):
    ...
    def __repr__(self):
        ...
        return fmt_str
    def set_clear_labels(self, clear_labels):
        self.clear_labels = clear_labels
       # for i in range(len(clear_labels)):
        #    if not clear_labels[i]:
        #        self.train_noisy_labels[i] = -1
...
class CIFAR100(data.Dataset):
    ...
    def set_clear_labels(self, clear_labels):
        print(clear_labels.size, self.train_noisy_labels.size)
        self.clear_labels = clear_labels
        for i in range(len(clear_labels)):
            if not clear_labels[i]:
                self.train_noisy_labels[i] = -1